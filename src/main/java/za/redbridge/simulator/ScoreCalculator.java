...
public class ScoreCalculator implements CalculateScore {
    ...
    public ScoreCalculator(SimConfig simConfig, int simulationRuns,
            Morphology sensorMorphology, double [] parameters, boolean isParamTuning, SEARCH_MECHANISM searchMechanism, int populationSize, int runNumber) {
    ...
    public double calculateScore(MLMethod method) {
        if (searchMechanism == SEARCH_MECHANISM.NOVELTY) {
            ...
            if (n.getPhenotypeBehaviour() == null) {
                ...
                log.debug("Novelty score calculation completed (easy, run "+ runNumber + "): " + noveltyScore);
                return noveltyScore;
            }
